...
class DiscountModel {
    ...
    factory DiscountModel.fromJson(Map<String, dynamic> json) => DiscountModel(
        ...
        availableItems: List<AvailableItem>.from(json["availableItems"].map((x) => AvailableItem.fromJson(x))),
    );

    Map<String, dynamic> toJson() => {
        "points": points,
        "availableCoupon": availableCoupon.toJson(),
        "availableItems": List<dynamic>.from(availableItems.map((x) => x.toJson())),
    };
}
